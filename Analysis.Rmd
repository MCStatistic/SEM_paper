...
fit_mes <- cfa(model = mod_mes_vis,
               estimator = "MLM",
               data = allbus_imp_vis) # KEEP GOING!
...
# Visualisierung (Fit-Maße müssen noch eingefügt werden, vllt. einfach mit PowerPoint?)
semPaths(fit_mes,
         nCharNodes = 0,
         whatLabels = "std",
         sizeLat = 10,
