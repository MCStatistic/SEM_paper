...
```{r}
allbus <- read_spss("/Users/marlonschumacher/Documents/2_Master/Git_Projekte/SEM_paper/data/allbus2016.sav") %>% 
...
colnames(allbus) <- c("Familie", "Arbeit", "Nachbar.", "Freund.", "wghtpew")
